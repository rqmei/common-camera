package lib.android.timingbar.com.view.handSign;
...
import lib.android.timingbar.com.view.handSign.util.SignFileOutputStream;
...
public class HandSignView extends View {
    ...
    private boolean isSign = false, isStartWrite = false;
    HandWriteInterface handEvent;
    ...
    public HandSignView(Context context, AttributeSet attrs) {
        this (context, attrs, 0);
    }

    public HandSignView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction ()) {
            case MotionEvent.ACTION_DOWN:
                if (handEvent != null && !isStartWrite) {
                    isStartWrite = true;
                    handEvent.onStartWrite (isStartWrite);
                }
    ...
    public void setHandWriteInterface(HandWriteInterface handEvent) {
        this.handEvent = handEvent;
    }

    public interface HandWriteInterface {
        void onStartWrite(boolean isStartWrite);
    }
}
